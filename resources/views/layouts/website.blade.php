            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link px-lg-3 py-3 py-lg-4" href="{{ route('website') }}">Home</a>
                        </li>
                    ...
                    <!-- Authentication Links -->
                        ...
                        @else
                         @if (Auth::user()->role_as == '1')
                               <li class="nav-item">
                                    <a class="nav-link px-lg-3 py-3 py-lg-4" href="{{ route('admin') }}">{{ __('Admin') }}</a>
                                </li>
                            @endif 
                         <li class="nav-item">
                                    <a class="nav-link px-lg-3 py-3 py-lg-4" href="{{ route('posts.index') }}">My Posts</a>
                                </li>
                             <li class="nav-item">
